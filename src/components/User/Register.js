                    ...
                    <Col xs="12" lg="6">
                        <Card className="shadow">
                            <Card.Body className="p-lg-5 p-4">
                                <h4 className="card-title mb-4 fw-bolder">Get started with Psodex!</h4>
                                <p className="text-muted small mb-5">Have a centralized place to record all your transactions, expenses, savings, and investments all in one place.</p>
                                <Form>
                                    ...
                                    <div className="form-floating mb-3">
                                        <input type="password" className="form-control" id="floatingConformPassword" placeholder="Confirm password" required autoComplete="off" name="password" value={password} onChange={this.credentialChange} />
                                    ...
                                    <Button className="mt-4 text-light" size="lg" type="button" variant="primary" onClick={this.validateUser}>Register
                                    </Button>
                                </Form>
                            </Card.Body>
                            <Card.Footer className="px-lg-5 py-lg-4 p-4">
                                <div className="small text-muted">Already have an account? <a href="/">Login</a>.</div>
                            </Card.Footer>
                        </Card>
                    </Col>
